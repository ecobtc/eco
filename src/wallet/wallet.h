...
public:
    ...
    bool CreateProof(uint256 nMerkleRoot, uint64_t nTime, int nHeight, std::string pSignature, const std::vector<CRecipient>& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet,
